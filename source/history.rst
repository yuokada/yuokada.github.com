...
- リダイレクト・サーバーの高速化対応
  ...
  - クライアントnginx間にKeep-Aliveの導入とレスポンスの圧縮による高速化
  - 副次的にレスポンスが小さくなったことでCPUの負荷が減った

- SSL証明書のSHA-2化対応、SSL証明書の発行会社切り替えの調整
- OJTトレーナー業務
- 某ビーコンサーバーの運用
...
- 某ビーコンドメイン統一作業
- 何千台のサーバーの監視の効率化(Now Working)
- Erlangで堅牢なシステムの構築(Now Working)


今年の四月からエンジニアらしいことしていない。。。
